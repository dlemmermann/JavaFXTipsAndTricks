...
public class NodesApp extends Application {
     ...
     */
        ...
        listView.setCellFactory(param -> new NodesCell());
    ...
    public final ListProperty<String> namesProperty() {
        if (names == null) {
            names = new SimpleListProperty<>(this, "names", FXCollections.observableArrayList());
        }
        return names;
    }
    ...
    public final void setNames(ObservableList<String> names) {
